...
SECTOR_MAP = {  # v3: 覆盖 50%→85%+(制造业/服务业粗粒化分流)
    "sh512880": ["证券", "资本市场服务", "货币金融", "金融服务"],
    "sh512800": ["银行", "货币金融", "金融服务"],
    "sh512010": ["医药", "制药", "医疗", "中药", "生物制品", "基因"],
    "sz159928": ["食品", "饮料", "白酒", "酿酒", "农牧", "渔业", "养殖", "零售"],
    "sh512690": ["白酒", "酿酒"],
    "sh512480": ["半导体", "集成"],
    "sz159995": ["半导体", "集成", "元件", "电子"],
    "sh512660": ["航天", "航空", "船舶", "航海", "兵装", "军工", "国防", "卫星"],
    "sh515030": ["汽车", "乘用车", "商用车", "电池", "新能源"],
    "sh515790": ["光伏", "电源", "电气机械", "新能源"],
    "sh512400": ["金属", "有色", "黄金", "贵金属", "矿物", "采掘", "煤炭", "矿业"],
    "sh512200": ["房地产", "建筑", "土木", "建材"],
    "sh512980": ["传媒", "游戏", "影视", "广告", "出版", "文化", "旅游", "教育"],
